...
class QT_ComputerHardware_MainGame : AppCompatActivity() {
    ...
    private var questionList: List<HardwareQuestion> = emptyList()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        FirebaseFirestore.getInstance().collection("quiz_hardware")
            .get()
                ...
                if (!snapshot.isEmpty) {
                    ...
                    questionList = rawQuestions.mapNotNull { map ->
                        ...
                        if (question != null && correct != null && wrong != null && wrong.size == 3) {
                            HardwareQuestion(question, correct, wrong)
                        } else null
                    }
                    ...
                    Log.e("QuizData", "quiz_hardware collection is empty")
                }
            }
    ...
    private fun showQuestion(index: Int) {
        ...
        val quizId = "hardware_default_id"
    ...
    private fun startQuestionTimer() {
        ...
        questionTimer = object : CountDownTimer((totalSeconds * 1000).toLong(), 1000) {
            ...
            override fun onFinish() {
                ...
                progressText.text = "0"
                Toast.makeText(this@QT_ComputerHardware_MainGame, "Time's up!", Toast.LENGTH_SHORT).show()
                wrongAnswerPopup.visibility = View.VISIBLE
                Handler(Looper.getMainLooper()).postDelayed({
                    wrongAnswerPopup.visibility = View.GONE
                    currentQuestionIndex++
